...
<g>
<rect x="20" y="20" width="100%" height="100%" fill="blue"></rect>
<text x="115" y="125" font-family="Verdana" font-size="55" fill="white">ABC</text>
</g>
</svg>`); 
    });
});
...
<text x="18" y="85" font-family="Verdana" font-size="20" fill="white">ABC</text>
</g>
</svg>`); 
    });
});
